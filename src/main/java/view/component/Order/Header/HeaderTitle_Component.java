...
public class HeaderTitle_Component extends javax.swing.JPanel {
    ...
    private void addComponents() {
        ...
        createBtn = new RoundedButton("Create New Order", true, 15, 35);
    ...
    private void addEvents() {
        ...
        createBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                OrderDetails_Component orderDetails_Component = new OrderDetails_Component(addProductDialog, headerTitle_Component);

                orderDetails_Component.setBorder(new LineBorder(Color.GRAY, 2));
                addProductDialog.add(orderDetails_Component);
