...
import view.component.Order.Order_Component.OrderList_Component;
import view.component.Order.Order_Component.Order_Component;
import view.component.Order.Title.Title_Component;
...
public class ProductPage_Component extends javax.swing.JPanel {
    ...
    private OrderList_Component productList_Component;
    ...
    private void addComponents() {
        ...
        productList_Component = new OrderList_Component();
        add(title_Component, BorderLayout.NORTH);
        add(productList_Component, BorderLayout.CENTER);
    }
    
    public void updateData(List<Order_Component> list) {
