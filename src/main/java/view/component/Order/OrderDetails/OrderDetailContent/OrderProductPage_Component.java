...
import view.component.Order.OrderDetails.OrderDetailContent.Product_Component.ProductList_Component;
import view.component.Order.OrderDetails.OrderDetailContent.Product_Component.Title.Title_Component;
 ...
 * @author PC
 */
public class OrderProductPage_Component extends javax.swing.JPanel {
    ...
    public OrderProductPage_Component(OrderProductContent_Component parent) {
        initComponents();
        this.parent = parent;
    ...
    public OrderProductPage_Component(OrderProductContent_Component parent, Bills bills) {
        initComponents();
        this.parent = parent;
        setLayout(new BorderLayout());
        addComponents(bills);
...
//    }
    ...
    private void addComponents(Bills bills) {
        title_Component = new Title_Component();
        productList_Component = new ProductList_Component(this, bills);
    ...
    void updateImportProducts(Bills bills, Customer customer, Address address, OrderHistory orderHistory, double deliveryFree, double totalPaid, double discount, double otherDiscount, double totalPrice) {
        productList_Component.updateImportProducts(bills, customer, address, orderHistory, deliveryFree, totalPaid, discount, otherDiscount, totalPrice);
    }

    void unfulfilledOrder(Bills bills, Customer customer, Address address, OrderHistory orderHistory, double deliveryFee, double totalPaid, double discount, double otherDiscount, double totalPrice) {
        productList_Component.unfulfilledOrder(bills, customer, address, orderHistory, deliveryFee, totalPaid, discount, otherDiscount, totalPrice);
    }
