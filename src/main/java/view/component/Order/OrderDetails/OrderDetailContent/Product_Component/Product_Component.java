...
import view.component.Order.OrderDetails.OrderDetailContent.Product_Component.Feature.OneFeature_Component;
import view.component.Order.OrderDetails.OrderDetailContent.Product_Component.Feature.ProductName_Component;
import view.component.Order.OrderDetails.OrderDetailContent.Product_Component.Feature.QuantityFeature_Component;
import view.component.Order.OrderDetails.OrderDetailContent.Product_Component.Feature.SubFeature_Component;
...
public class Product_Component extends javax.swing.JPanel {
    ...
    private void addComponents(Product product) {
        ...
        total = new OneFeature_Component(product.getPrice());
        add(total);
